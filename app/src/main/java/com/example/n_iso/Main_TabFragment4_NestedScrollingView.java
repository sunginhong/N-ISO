...
public class Main_TabFragment4_NestedScrollingView extends NestedScrollView {
    ...
    public Main_TabFragment4_NestedScrollingView(Context context) {
        super(context);
    }

    public Main_TabFragment4_NestedScrollingView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Main_TabFragment4_NestedScrollingView(Context context, AttributeSet attrs, int defStyleAttr) {
